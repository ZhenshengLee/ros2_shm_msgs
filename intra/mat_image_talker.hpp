...
#include "mat_image_container.hpp"

using namespace std::chrono_literals;
using namespace cv_bridge;

// RCLCPP_USING_CUSTOM_TYPE_AS_ROS_MESSAGE_TYPE(
//   shm_msgs::ROSCvMatContainer,
//   sensor_msgs::msg::Image);

class Talker : public rclcpp::Node {
private:
  using Topic = rclcpp::TypeAdapter<shm_msgs::ROSCvMatContainer, sensor_msgs::msg::Image>;
  using DataType = shm_msgs::ROSCvMatContainer;

public:
  explicit Talker()
      : Node("mat_image_talker", rclcpp::NodeOptions().use_intra_process_comms(true)) {
    ...
    auto publishMessage = [this]() -> void {
      ...
      auto msg = std::make_unique<DataType>(m_input_cvimage->image, m_input_cvimage->header);
    ...
    m_publisher = this->create_publisher<Topic>("mat_image", custom_qos_profile);
