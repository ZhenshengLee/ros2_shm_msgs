#ifndef SHM_MSGS__CV_MAT_SENSOR_MSGS_IMAGE_TYPE_ADAPTER_HPP_
#define SHM_MSGS__CV_MAT_SENSOR_MSGS_IMAGE_TYPE_ADAPTER_HPP_
...
template<>
struct rclcpp::TypeAdapter<shm_msgs::ROSCvMatContainer, sensor_msgs::msg::Image>
{
  using is_specialized = std::true_type;
  using custom_type = shm_msgs::ROSCvMatContainer;
  ...
  {
    destination = shm_msgs::ROSCvMatContainer(source);
  }
};

#endif  // SHM_MSGS__CV_MAT_SENSOR_MSGS_IMAGE_TYPE_ADAPTER_HPP_