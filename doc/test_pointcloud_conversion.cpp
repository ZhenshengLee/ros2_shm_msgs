...
#include "shm_msgs/point_cloud_conversion.hpp"
#undef shm_msgs_SKIP_WARNING

#include "shm_msgs/point_field_conversion.hpp"

TEST(shm_msgs, PointCloudConversion)
{
  // Build a PointCloud
  shm_msgs::msg::PointCloud cloud;

  cloud.header.stamp.sec = 100;
  cloud.header.stamp.nanosec = 500;
  cloud.header.frame_id = "cloud_frame";

  shm_msgs::msg::ChannelFloat32 intensity, range;
  ...
  shm_msgs::msg::PointCloud2 cloud2;
...
#endif
  auto ret_cc2 = shm_msgs::convertPointCloudToPointCloud2(cloud, cloud2);
#ifdef _MSC_VER
#pragma warning(pop)
#else
#pragma GCC diagnostic pop
  ...
  shm_msgs::msg::PointCloud cloud3;
#ifdef _MSC_VER
#pragma warning(push)
#pragma warning(disable : 4996)
#else
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
#endif
  auto ret_c2c = shm_msgs::convertPointCloud2ToPointCloud(cloud2, cloud3);
#ifdef _MSC_VER
#pragma warning(pop)
#else
#pragma GCC diagnostic pop
