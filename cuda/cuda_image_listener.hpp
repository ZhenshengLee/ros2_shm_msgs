...
public:
  explicit Listener()
      : Node("cuda_image_listener", rclcpp::NodeOptions().use_intra_process_comms(true)) {
    ...
    m_subscription = create_subscription<Topic>("cuda_image", custom_qos_profile, callback);
  }
